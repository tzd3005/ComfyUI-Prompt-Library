"""Prompt Library 中文版节点 — Loader（带行号摘要）+ 自带文本预览。
...
节点 className（技术名）:
  - ComfyUI_Prompt_Library_CN   : 提示词加载器（中文版）
  - ComfyUI_Prompt_Preview_CN   : 提示词预览（中文版）
"""
...
class PromptLibraryLoaderCN:
    ...
    def 获取提示词(
        ...
        if abs_path is None or not os.path.isfile(abs_path):
            print(f"[提示词库:中文版] 警告：找不到文件: {提示词文件}")
            return ("", "")
...
NODE_CLASS_MAPPINGS = {
    "ComfyUI_Prompt_Library_CN": PromptLibraryLoaderCN,
    "ComfyUI_Prompt_Preview_CN": PromptPreviewCN,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ComfyUI_Prompt_Library_CN": "提示词库加载器（中文版）",
    "ComfyUI_Prompt_Preview_CN": "提示词预览（中文版）",
}
